...
- **Задача:** [`TASK_020_ACCOUNTS_APPLE_REDESIGN`](tasks/TASK_020_ACCOUNTS_APPLE_REDESIGN.md)
- **Статус:** `DONE` (595 passed, 0 failed по всем 8 файлам тестов, без
  регрессий; проверено в браузере — карточка капитала/карточки категорий/
  раскрытие/режим сортировки и drag/меню группы/архив/создание и удаление
  счёта/распределение капитала, светлая и тёмная тема, мобильная ширина,
  консоль без ошибок)
- Ранее завершённые задачи: [`TASK_019_ANALYTICS_APPLE_REDESIGN`](tasks/TASK_019_ANALYTICS_APPLE_REDESIGN.md),
...
Нет. `TASK_020_ACCOUNTS_APPLE_REDESIGN` — статус `DONE`, полный
...
`TASK_020_ACCOUNTS_APPLE_REDESIGN` завершена; следующая задача не
определена — ждёт постановки пользователем. Production-верификация
`finance-v163` — см. §10 `TASK_020_ACCOUNTS_APPLE_REDESIGN.md`.
